...
from cpmnurik2010 import CPMNurik2010

__CHANNEL_USERNAME__ = "Cpmnurik2010Kurd"
__GROUP_USERNAME__   = "Cpmnurik20_10Kurd"
...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, Center.XCenter(Box.DoubleCube("𝐏𝐋𝐄𝐀𝐒𝐄 𝐋𝐎𝐆𝐎𝐔𝐓 𝐅𝐑𝐎𝐌 𝐂𝐏𝐌 𝐁𝐄𝐅𝐎𝐑𝐄 𝐔𝐒𝐈𝐍𝐆 𝐓𝐇𝐈𝐒 𝐓𝐎𝐎𝐋"))))
